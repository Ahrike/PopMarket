    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           // services.AddTransient<IPayStackService, PayStackService>();
            ...
            Configuration.Bind("PayStackConfig", payStackConfig);

            services.AddHttpClient("PayStackService", client =>
            {
                client.BaseAddress = new Uri(payStackConfig.BaseUrl);

                client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", payStackConfig.PayKey);
            });
